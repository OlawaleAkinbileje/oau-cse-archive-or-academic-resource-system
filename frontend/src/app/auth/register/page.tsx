        ...
        <div className="flex items-center justify-center min-h-screen bg-gray-50 p-6 lg:p-12">
          <div className="w-full max-w-md">
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 md:p-10">
              <div className="mb-8">
                <h1 className="text-[#0a1628] text-2xl md:text-3xl font-bold mb-2">Create your account</h1>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-semibold text-[#0a1628] mb-2">Confirm Password</label>
                  <div className="relative">
                    <div className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400">
                      <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <rect x="3" y="11" width="18" height="11" rx="2" ry="2" />
                ...
                <label className="flex items-start gap-3 pt-2 cursor-pointer select-none">
                  <input
                    ...
                    className="w-4 h-4 mt-0.5 rounded border-gray-300 focus:ring-[#d4a017] text-[#0a1628]"
                    style={{ accentColor: "#0a1628" }}
                  />
                  <span className="text-sm text-gray-600 leading-relaxed">
                    I agree to the{" "}
                    <a href="#" className="font-semibold hover:underline" style={{ color: "#d4a017" }}>Terms of Service</a>
                    {" "}and{" "}
                    <a href="#" className="font-semibold hover:underline" style={{ color: "#d4a017" }}>Privacy Policy</a>
                  </span>
                </label>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="btn-primary w-full py-3.5 rounded-lg disabled:opacity-60 disabled:cursor-not-allowed text-sm shadow-lg shadow-[#0a1628]/20 hover:shadow-xl hover:shadow-[#0a1628]/25 transition-all mt-2"
                >
                  {loading ? (
              ...
              <div className="mt-8 pt-6 border-t border-gray-100">
                <p className="text-center text-sm text-gray-600">
                  ...
                  <Link href="/auth/login" className="font-bold hover:underline" style={{ color: "#d4a017" }}>
                    Sign In
                  </Link>
                </p>
              </div>
